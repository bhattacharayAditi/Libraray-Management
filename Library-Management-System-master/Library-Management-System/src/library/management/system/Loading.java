...
/*
* swing is the superset of awt
* it has almost feature of awt
*/
import java.awt.event.*; //import subpackage of awt package
import java.sql.*;
...
public class Loading extends JFrame implements Runnable {
	...
	Connection conn;
	int s;
	Thread th; // explicit thread class object reference
	...
	public void setUploading() {
            //setVisible(false);
            th.start(); //start method to call run() internally
	}
	...
	public void run() {
            try {
                for (int i = 0; i < 200; i++) {
                    s = s + 1;
                    int m = progressBar.getMaximum(); //max value is 100
	...
	public Loading() {
            ...
            super(" Loading "); //set title on the frame
