...
public class aboutUs extends JFrame{
	...
	private JTextArea t1;
        ...
        public aboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : Aditi Bhattacharya");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel(" Contact: anjalisantoshb@gmail.com ");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel(" About Project ");
            ...
            JTextArea t1 =new JTextArea("" +
                    ...
                    "\n is an application for assisting a " +
                    "\n librarian in managing a book " +
                    "\n library in a university.");
            t1.setFont(new Font("Trebuchet MS",Font.BOLD,20));
            t1.setBounds(70, 300, 600, 200);
            contentPane.add(t1);
